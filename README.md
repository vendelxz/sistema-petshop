...
Este é um projeto Java com Spring Boot para gerenciamento de um petshop. Nele é possível cadastrar clientes, funcionários, pets e realizar operações básicas de CRUD por meio de uma API REST.
